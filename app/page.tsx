      ...
      <main className="flex-grow">
        ...
        <section className="py-16 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-12">Připravované eventy</h2>
        ...
        <section className="py-16 bg-gradient-to-br from-gray-900 to-gray-800 text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold mb-4">Prémiové služby</h2>
              <p className="text-gray-300 text-lg max-w-2xl mx-auto">Vylepši si herní zážitek s našimi prémiovými balíčky</p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
              <PremiumCard title="Premium hráč" price="150 Kč" period="měsíc" features={['Přednost při eventech', 'Exkluzivní Discord role', 'VIP přístup k akcím']} />
              <PremiumCard title="Premium+ hráč" price="400 Kč" period="3 měsíce" features={['Vše z Premium', 'Extra kosmetika', 'Speciální herní odměny']} highlighted />
              <PremiumCard title="Revive balíček" price="200 Kč" period="5 kreditů" features={['Okamžitý revive na MC', 'Prioritní vyřízení', 'Možnost převodu na kamarády']} />
            </div>
          </div>
        </section>
      </main>
